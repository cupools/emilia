...
function emilia() {
  ...
  var bundles = raw.map(_util2.default.map(assignBuffer, assignPath, assignTag));

  var assignGroup = function assignGroup(item) {
    return (0, _extends3.default)({}, item, { group: getGroup.bind(null, bundles)(item.tag) });
  };
  var assignSprite = function assignSprite(item) {
    return (0, _extends3.default)({}, item, { sprite: getSprite.bind(null, processor, bundles)(item.group) });
  };
